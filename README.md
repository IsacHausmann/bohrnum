...
The Current Maintainer of this work is Isac D. Hausmann.
...
principle and taking consideration to some outliers.

Features include:
- Automatic Aufbau filling
- Chromium/Copper/Molybdenum/Silver/Gold exceptions
...
### From source
Copy `bohrnum.sty` into your document folder
